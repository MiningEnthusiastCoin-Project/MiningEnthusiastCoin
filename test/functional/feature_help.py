...
"""Verify that starting miningenthusiastcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start miningenthusiastcoin with -h for help text")
        ...
        self.log.info("Start miningenthusiastcoin with -version for version information")
