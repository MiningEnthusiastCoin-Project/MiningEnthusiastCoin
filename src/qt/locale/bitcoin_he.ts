...
<context>
    ...
    <message>
        ...
        <translation>???? ??????? (????? ?? ????? ???? QR ??????? ?????? ???? ?? :miningenthusiastcoin)</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>????? ??? ???? ???? ????????</numerusform><numerusform>%n ??????? ?????? ???? ????????</numerusform><numerusform>%n ??????? ?????? ???? ????????</numerusform><numerusform>%n ??????? ?????? ???? ????????</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>?? ???? ?????? ?? ????? miningenthusiastcoin: click-to-pay</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>?-maxmempool ???? ????? ????? %d ???</translation>
    </message>
    <message>
