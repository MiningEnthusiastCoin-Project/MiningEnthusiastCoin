...
<context>
    ...
    <message>
        ...
        <translation>?????: ??? ??? ?????? ?????? ????? ???? ?????? ????? ??, ????? ?? ????? MININGENTHUSIASTCOINS ?????? ??.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>??? URI : MiningEnthusiastCoin ?? ??? ???</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>??? ?? ????? %s: ?? ????? ????? ????? ??? ????? ??????? ??????? non-HD ???????? ??? ???????.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>??? ?? ????? ????? ?????? chainstate</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>??? ????? ????? %s: ?? ????? ????? ????? ??????? ??????? HD ?? ????? ?? ???? ????? ??????? ??????? non-HD ??????</translation>
    </message>
    <message>
