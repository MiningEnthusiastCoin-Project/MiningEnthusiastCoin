...
<context>
    ...
    <message>
        ...
        <translation>miningenthusiastcoin: URI ?? ???? ??</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>%1? MiningEnthusiastCoin ?? ??? ??? ?????? ?????.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>??-?? URLs (?. ?? ???)? ?? ?? ???? ??? ?????. URL? %s? ?? ????? ?????. ?? URLs? ?? ? | ?? ??? ???.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>????? MiningEnthusiastCoin ????? ??? ????? ???. ????? UPnP? ???? ??? ?? ???? ?????.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>??: ????? ???? ????: %1. key=value syntax? ???????.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Bech32 ?? (BIP-173)? ? ?? ???? ??????? ??? ???. Bech32? ???? ????? P2SH ??? ??? ??? ?? ?????.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Fallbackfee? ???? ? ?? ?? ??? ??? ?? ? ??? ? ?? ?? ? ? (?? ???) ? ?? ? ????. ???? ???? ????? ?? ??? ???? ??? ??? ??????.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>??? ?? ???? 1000???? ??? ?? ??? ??? 250??? ? ?? 1?????? 250???? ????? "?? ???"?? 1000???? ?????. 1?????? ?? ??? ?? ??? ???? 1????? ???? ?????.</translation>
    </message>
    <message>
        <source>Hide</source>
        <translation>???</translation>
    ...
    <message>
        ...
        <translation>(Smart fee? ?? ??? ?? ?????. ?? ??? ???? ?? ? ?? ???????...)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Replace-By-Fee (BIP-125) ??? ?? ??? ??? ??? ??? ???.
? ??? ?? ?? ?? ??? ???? ?? ? ?? ???? ?????.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>??? ?? ??? ?? intent/purpose</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&lt;category&gt;? ???? ??? &lt;category&gt; = 1 ? ??, ?? ??? ??? ??</translation>
    </message>
    <message>
        <source>Prune configured below the minimum of %d MiB.  Please use a higher number.</source>
        <translation>?? ??? ???? %d MiB ??? ???? ????. ? ?? ?? ??? ???.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>? ??? ??? ??? ?? ??? ? ??? ???? ????? ???? ??? ?? ??? (0? ?? ??, ???: %s, testnet: %s)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>DNS lookup? ?? ?? ??? ?? ?? ??? (???: 1 -connect ??)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>??(Listen) ??? ???? ?? UPnP ?? (???: ????? -proxy ??? ???? ?? ? 1)</translation>
    </message>
    <message>
        <source>Username and hashed password for JSON-RPC connections. The field &lt;userpw&gt; comes in the format: &lt;USERNAME&gt;:&lt;SALT&gt;$&lt;HASH&gt;. A canonical python script is included in share/rpcuser. The client then connects normally using the rpcuser=&lt;USERNAME&gt;/rpcpassword=&lt;PASSWORD&gt; pair of arguments. This option can be specified multiple times</source>
        <translation>?????JSON-RPC ??? ??? ??? ???? ???. &lt;userpw&gt; ??? &lt;USERNAME&gt;:&lt;SALT&gt;$&lt;HASH&gt; ???? ???? ????. ??? ??? ?????? share/rpcuser? ???? ????. ?? ?? ?????? rpcuser=&lt;USERNAME&gt;/ rpcpassword=&lt;PASSWORD&gt; ?? ??? ???? ????? ?????. ? ??? ??? ??? ? ????.</translation>
    </message>
    <message>
        <source>Wallet will not create transactions that violate mempool chain limits (default: %u)</source>
        <translation>??? mempool chain limit (???: %u) ? ???? ??? ???? ????.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>??? ?(pool) ?? ?? ??(replacement) ??? (???: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>?? ??? ?? ?????-File Descriptor-? ?????. </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>full-RBF opt-in? ??? ? ??? ?????. (???: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>??(Listen) ??? ???? ?? UPnP ?? (???: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>??? ??? ?? (???: ????? -externalip ? -proxy ??? ??? 1)</translation>
    </message>
    <message>
        <source>Error: Listening for incoming connections failed (listen returned error %s)</source>
        <translation>??: ???? ??? ??(Listen)??? ?????? (?? ?? %s)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>onion ??? ???? Tor ?? ?? ?? (???: %s)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>??? ??? ????? JSON-RPC ??? ?????. ? ??? -rpcallowip? ???? ??? ?????. ??? ???? -rpcport? ?????. IPv6? ?? [host]:port ???? ??????. ? ??? ?? ? ?? ? ? ???? (??? : 127.0.0.1 ? ::1 ?, localhost ?? -rpcallowip? ???? 0.0.0.0 ? ?? ??).</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>getrawtransaction? RPC CALL? ?? ??? ?? ??? ?? (???: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>non-segwit(0) ?? segwit(1) (???: %d) ? ?? ??? ?? ?? ??? ?? ? ?? ?? ?? ?? hex? ???? ?????.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>? ???? OpenSSL Project?? OpenSSL Toolkit %s?? ???? ?? ?? ? ?????? Eric Young? ??? ??? ????? ? Thomas Bernard? ??? UPnP ?????? ???? ????.</translation>
    </message>
    <message>
        <source>Total length of network version string (%i) exceeds maximum length (%i). Reduce the number or size of uacomments.</source>
        <translation>???? ?? ?? (%i)? ??? ???? (%i)? ?????. UA???? ??? ??? ????.</translation>
    </message>
    <message>
        <source>Tries to keep outbound traffic under the given target (in MiB per 24h), 0 = no limit (default: %d)</source>
        <translation>????? ???? ??? ??? ??? ???? (24??? MiB??), 0 = ??? (???: %d)</translation>
    </message>
    <message>
        <source>Unsupported argument -socks found. Setting SOCKS version isn't possible anymore, only SOCKS5 proxies are supported.</source>
        <translation>???? ?? ?? -socks? ?????. ??? SOCKS? ??? ??? ??? ? ???, SOCK5 ????? ?????.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>DNS lookup? ?? ?? ????? ?? ?? ??? (???: %u)</translation>
    </message>
    <message>
